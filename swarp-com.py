# swarp wrapper for image combination
# 'obj.list' file is needed for input file list
# 2016/06/15, Changsu Choi started, not completed
...
# inlist = list(inlist)
# print 'obj.list file for input, files below will be combined'
# for inim in inlist : print inim

# swarp configuration file, if you use other one, then specify its path.
os.system('swarp -d > default.swarp')
swarp_conf='default.swarp'


swarp_command='swarp @obj.list -c '+swarp_conf + opt_out +opt_combine+opt_resample

#options
opt_out=' -IMAGEOUT_NAME '+ output
opt_coadd_1=' -COMBINE Y'
opt_coadd_2=' -COMBINE_TYPE MEDIAN' # MEDIAN,AVERAGE,MIN,MAX,WEIGHTED,CLIPPED
...
'''
# Default configuration file for SWarp 2.41.2
# EB 2020-03-17
#
#----------------------------------- Output -----------------------------------
IMAGEOUT_NAME          coadd.fits      # Output filename
