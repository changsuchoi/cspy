...
def psfex(i):
	...
	presecom = 'sex -c '+configdir+'prepsfex.sex '+i+' -CATALOG_NAME '+fn+'.prese.cat -PARAMETERS_NAME '+configdir+'prepsfex.param '+ '-FILTER_NAME '+configdir+'default.conv' + ' -PHOT_APERTURES '+arcsec5
	...
	psfexcom = 'psfex -c '+configdir+'default.psfex '+fn+'.prese.cat'+opt1+opt6 
	os.system(presecom)
	os.system(psfexcom)
...
for inimage in inlist :
	...
	fwhm.append(psfexxml(fn+'psfex.xml'))
